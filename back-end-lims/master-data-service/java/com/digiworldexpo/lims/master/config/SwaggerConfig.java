package com.digiworldexpo.lims.master.config;
...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info().title("Master Data Service API")
                        .description("API documentation for Master Data Service with JWT Authentication"))
